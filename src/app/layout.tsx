...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/logos/LOGO PA GROUP BLACK.png?v=2", type: "image/png" },
    ],
    shortcut: "/logos/LOGO PA GROUP BLACK.png?v=2",
    apple: "/logos/LOGO PA GROUP BLACK.png?v=2",
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <link rel="icon" href="/logos/LOGO PA GROUP BLACK.png?v=2" type="image/png" sizes="any" />
      </head>
