...
// ── Featured Corporate Clients / Logos ───────
const clients = [
...
const heroSlides = [
  {
    ...
    client: "Corporate Client · Surabaya",
  },
  {
    src: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&w=800&q=80",
    alt: "Product Launch",
    title: "Product Launch",
    client: "Brand Client · Bali",
  },
  {
    src: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&w=800&q=80",
    alt: "Awards Gala",
    title: "Awards Night",
    client: "Enterprise Client · Jakarta",
  },
  {
...
export default function Oneway() {
  ...
  // No native scrollLeft and no CSS keyframe animation are used anymore —
  // mixing those with a transform was what let the visible offset drift
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-5 pr-6 sm:pr-12 lg:pr-0">
              <div className="mb-6 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[11px] tracking-widest text-zinc-300 uppercase backdrop-blur-md">
                <span>Corporate Events &amp; Exhibitions</span>
              </div>

              {/* Accessible Header with Logo Image */}
              <h1 className="sr-only">Project Art Corporate</h1>
              <div className="relative h-16 sm:h-20 lg:h-28 w-full max-w-md my-4">
                <Image
              ...
              <p className="mt-6 max-w-lg text-base leading-relaxed text-zinc-400 sm:text-lg">
                Elevating corporate experiences, galas, and brand exhibitions with seamless execution and high-impact concepts.
              </p>
            ...
            {/* Right: Carousel — draggable, infinite loop driven entirely by JS transform */}
      ...
      <section className="border-t border-white/10 bg-black px-6 py-20 sm:px-12 sm:py-28">
        <div className="mx-auto max-w-6xl grid gap-12 sm:grid-cols-2">
          <div>
            ...
            <h2 className="mt-4 font-display text-3xl text-white sm:text-4xl">
              High-impact corporate experiences &amp; activations
            </h2>
            <p className="mt-4 max-w-md text-sm leading-relaxed text-zinc-400">
              From global product launches to corporate galas, we handle end-to-end production so your brand makes a lasting impression.
            </p>
          ...
          <div>
            ...
            <p className="mt-4 max-w-md text-sm leading-relaxed text-zinc-400">
              Every destination below has seen a Project Art Corporate event produced with excellence.
            </p>
            <ul className="mt-8 flex flex-wrap gap-2">
              {cities.map((c) => (
                <li
      ...
      <section id="contact" className="border-t border-white/10 bg-black px-6 py-20 sm:px-12 sm:py-28">
        <div className="mx-auto max-w-6xl grid gap-12 sm:grid-cols-[1.2fr_1fr] sm:items-start">
          <div>
            ...
            <p className="mt-4 max-w-md text-sm leading-relaxed text-zinc-400">
              Tell us your corporate event objectives, timelines, and preferred venue. Our team will handle execution.
            </p>
          </div>
