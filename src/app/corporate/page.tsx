            ...
            <div className="flex flex-1 flex-col justify-center px-6 sm:px-12 lg:px-20">
              ...
              >
                <Link
                  href="#contact"
                  onClick={closeMenu}
                  className="inline-flex items-center gap-3 rounded-full border border-white/25 px-6 py-2.5 sm:px-7 sm:py-3 text-xs sm:text-sm tracking-widest text-white uppercase transition-all hover:bg-white hover:text-black"
                >
                  Inquire / Talk to Us <span className="text-base">→</span>
                </Link>
              </div>
            </div>
